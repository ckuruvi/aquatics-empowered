...
exports.getFacilityId=function(userId){
  return query(
    "SELECT id FROM facilities where users_id=$1 ;",
    [userId]
...
exports.getTimeSlots=function(date,facilityId){
  return query(
    "SELECT * FROM facility_availability where facility_id=$2 and date=$1;",
    [date,facilityId]
...
exports.setTimeSlots=function(facilityId,date,startTime,endTime){
  ...
  return query(
    "INSERT INTO facility_availability(facility_id,date,start_time,end_time) values ($1,$2,$3,$4);",
